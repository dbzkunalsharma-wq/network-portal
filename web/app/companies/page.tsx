...
export const metadata: Metadata = {
  title: { absolute: "Companies hiring Strategy & Ops in the US · Network Portal" },
  description:
    "Browse every US company hiring Strategy & Operations, BizOps, Corporate Strategy, Growth & Pricing and Strategic Finance roles on Network Portal, deduped by company with open-role counts.",
  alternates: { canonical: "/companies" },
  openGraph: {
    type: "website",
    title: "Companies hiring Strategy & Ops in the US · Network Portal",
  ...
  twitter: { card: "summary_large_image", title: "Companies hiring Strategy & Ops in the US · Network Portal", description: "Every US company hiring Strategy & Ops talent, deduped with open-role counts.", images: [OG_IMAGE] },
};
  ...
  return (
    <main className="flex min-h-dvh flex-col">
      <div className="mx-auto w-full max-w-6xl px-4 pb-24 pt-8 sm:px-6 sm:pt-12 lg:px-8">
        ...
        <div className="mt-8">
          <h1 className="text-balance text-2xl font-semibold tracking-tight text-chalk sm:text-3xl">Companies hiring Strategy &amp; Ops in the US</h1>
