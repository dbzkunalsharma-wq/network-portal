    ...
    <footer className="mt-auto border-t border-ink/10 py-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-sm text-ink/55">
            <span className="font-mono font-semibold text-brand">DOD US</span>
            <span className="text-ink/25" aria-hidden="true">·</span>
            <span>Live US Strategy &amp; Ops jobs</span>
            <span className="text-ink/25" aria-hidden="true">·</span>
            <a
              href="/feed.xml"
              className="inline-flex items-center gap-1 text-ink/55 underline-offset-2 hover:text-ink hover:underline"
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-ink/45">
            <span className="font-medium tabular-nums text-ink/70">{loading ? "—" : total.toLocaleString("en-US")}</span>
        ...
        <div className="border-t border-ink/[0.06] pt-4 text-xs leading-relaxed text-ink/35">
          <p>
          ...
          <p className="mt-1.5">
            DOD US is an independent jobs aggregator and is not affiliated with, endorsed by, or
